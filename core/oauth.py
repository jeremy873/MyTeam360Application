...
def _error_page(message):
    ...
    .msg{{color:#f87171;font-size:16px;max-width:400px;text-align:center}}a{{color:#a459f2;text-decoration:none}}</style></head>
...
def _success_page(token, user):
    ...
    .spin{{width:40px;height:40px;border:3px solid #1c1c36;border-top-color:#a459f2;border-radius:50%;animation:s 0.8s linear infinite}}
